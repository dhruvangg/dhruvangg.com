        ...
        <header className="body-font bg-gray-100 dark:bg-black w-full">
            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
                    <Link href="/"><a className="mr-5 text-black dark:text-white">Home</a></Link>
                    <Link href="/articles"><a className="mr-5 text-black dark:text-white">Article</a></Link>
                    <Link href="https://drive.google.com/file/d/1JqX1lxDO6vEObWCgiaFd_1hvimfJvRkt/view"><a className='mr-5 text-black dark:text-white' target="_blank">Resume</a></Link>
