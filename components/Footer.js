export default function Footer() {
    return (
        <footer className="flex items-center h-96 dark:text-gray-50">
            <div className="mx-4 max-w-1/2 mx-auto sm:w-full sm:px-4 text-center">
                ...
                <ul className="flex items-center my-4 justify-center">
                    <li><a href="https://stackoverflow.com/users/7738692/dhruvang-gajjar" className="p-2 block mr-4"><svg className="fill-black dark:fill-white" width="20" height="20" xmlns="http://www.w3.org/2000/svg" fill="#000" viewBox="0 0 384 512" stroke="#000">
                    ...
                    <li><a href="https://github.com/dhruvangg" className="p-2 block mr-4"><svg className="fill-black dark:fill-white" width="20" height="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 496 512" stroke="#000">
                    ...
                    <li><a href="https://dev.to/dhruvangg"><svg className="fill-black dark:fill-white" width="20" height="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 496 512" stroke="#000">
